      ...
      <div className="admin-card" style={{ padding: "32px" }}>
        <form action={createBerita}>
          ...
          <div style={{
            ...
            padding: "16px 20px", background: "rgba(255,255,255,0.04)", borderRadius: "12px",
            border: "1px solid #c8c2e8", marginBottom: "24px",
          }}>
            <div>
              <div style={{ fontWeight: 600, fontSize: "14px", color: "#f8f8ff" }}>Status Publikasi</div>
              <div style={{ fontSize: "12px", color: "#c8c2e8", marginTop: "2px" }}>Aktifkan agar berita langsung tampil ke publik</div>
            </div>
            <label style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer" }}>
              <input type="checkbox" name="is_published" defaultChecked style={{ width: "18px", height: "18px", accentColor: "#a855f7", cursor: "pointer" }} />
              <span style={{ fontSize: "13px", fontWeight: 600, color: "#ddd6fe" }}>Published</span>
            </label>
          </div>
          ...
          <div className="admin-form-group">
            ...
            <div style={{ fontSize: "12px", color: "#c8c2e8", marginTop: "4px" }}>Gunakan link gambar dari Unsplash, ImgBB, atau hosting lainnya.</div>
          </div>
          ...
          <div className="admin-form-group">
            ...
            <div style={{ fontSize: "12px", color: "#c8c2e8", marginTop: "4px" }}>Gunakan tag HTML untuk format teks (paragraf, bold, list, dll.)</div>
          </div>
